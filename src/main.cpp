...
class Handler_CONTRACT_ : public HandlerInterface, public HandlerUtility_
{
public:
    Handler_Contract_() : HandlerUtility_(CONTRACT) {}
...
Handler_Contract_ handler_contract_;
